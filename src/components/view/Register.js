	...
	render() {
		return (
			<div>
				...
				<button className="button small" onClick={this.submitRegistration.bind(this)}>Join</button>
				<button className="button small" onClick={this.submitLoginCredentials.bind(this)}>Sign In</button>
